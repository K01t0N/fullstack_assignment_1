...
import { createPost, listAllPosts, listPostsByTag, listPostsByAuthor, getPostById, updatePost, deletePost } from '../services/posts.js'
...
beforeAll(async () => {
    ...
    samplePosts = [
     ...
     { title: 'Full-Stack React Projects', author: testUser._id, tags: ['react', 'nodejs'],},
     ]
})
...
describe('listing posts', () => {
    ...
    test('should return all posts sorted by creation date descending order', async () => {
        const posts = await listAllPosts()
...
describe('getting a post', () => {
    ...
    test('should fail if the id should not exist', async() => {
...
describe('updating posts', () => {
    test('should update the specified property', async () => {
        await updatePost(testUser._id, createdSamplePosts[0]._id, {contents: 'some content change'})
    ...
    test('should fail if the id does not exist', async () => {
        const post = await updatePost(testUser._id, '000000000000000000000000', { author: 'Test Author', })
        expect(post).toEqual(null)
    })
})
